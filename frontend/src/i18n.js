...
const TRANSLATIONS = {
  ru: {
    ...
    'weather.wind10m': 'Ветер · 10 м · ECMWF IFS',
    'weather.windOff': 'ECMWF IFS · поле ветра 10 м',
    ...
    'weather.directionNote': 'Стрелки показывают, куда движется воздух. Метеорологическое направление FROM показано по клику.',
  ...
  en: {
    ...
    'weather.wind10m': 'Wind · 10 m · ECMWF IFS',
    'weather.windOff': 'ECMWF IFS · 10 m wind field',
    ...
    'weather.directionNote': 'Arrows show where the air moves TO. Meteorological FROM direction is shown on click.',
