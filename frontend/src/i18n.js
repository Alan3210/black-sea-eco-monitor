...
const TRANSLATIONS = {
  ru: {
    ...
    'weather.layers': 'АТМОСФЕРА',
    'air.cams': 'Качество воздуха · CAMS',
    'air.pollutant': 'Загрязнитель',
    'air.ready': 'CAMS · поле готово',
    'air.readyDetailed': 'CAMS · {pollutant} · {time} · модельный прогноз',
    'air.loading': 'Загрузка CAMS…',
    'air.off': 'CAMS · слой выключен',
    'air.error': 'CAMS недоступен: {message}',
    'air.modelForecast': 'Модельный прогноз · CAMS Ensemble',
    'air.minimum': 'МИН',
    'air.mean': 'СРЕДН',
    'air.maximum': 'МАКС',
    'air.opacity': 'Прозрачность поля',
    'air.opacityAria': 'Прозрачность поля качества воздуха CAMS',
    'air.clickHint': 'Кликните по полю, чтобы увидеть локальную модельную концентрацию.',
    'air.popupTitle': 'КАЧЕСТВО ВОЗДУХА · CAMS',
    'air.value': 'КОНЦЕНТРАЦИЯ',
    'air.validTime': 'ВРЕМЯ МОДЕЛИ',
    'air.forecastRun': 'FORECAST RUN',
    'air.model': 'МОДЕЛЬ',
    'air.modelDisclaimer': 'Модельное значение CAMS Ensemble. Это не измерение наземной станции.',
    'weather.wind10m': 'Ветер · ECMWF IFS',
    'weather.windOff': 'ECMWF IFS · поле ветра',
    'weather.windLoading': 'Загрузка поля ветра ECMWF IFS…',
    'weather.windReady': 'ECMWF IFS · {time} · {count} векторов · run {run}',
    'weather.windError': 'Ветер недоступен: {message}',
    'weather.arrowSize': 'Размер стрелок',
    'weather.arrowSizeAria': 'Размер стрелок ветра',
    'weather.displayMode': 'Отображение',
    'weather.displayModeAria': 'Режим отображения ветра',
    'weather.modeArrows': 'Стрелки',
    'weather.modeParticles': 'Частицы',
    'weather.modeBoth': 'Стрелки + частицы',
    'weather.particleCount': 'Количество частиц',
    'weather.particleCountAria': 'Количество частиц ветра',
    'weather.particleSpeed': 'Скорость анимации',
    'weather.particleSpeedAria': 'Скорость анимации ветра',
    'weather.particleTrail': 'Длина следа',
    'weather.particleTrailAria': 'Длина следа частиц ветра',
    'weather.particleSize': 'Размер частиц',
    'weather.particleSizeAria': 'Размер частиц ветра',
    'combined.title': 'СОВМЕСТНЫЙ РЕЖИМ',
    'combined.currents': 'Течения',
    'combined.wind': 'Ветер',
    'combined.windMeanSpeed': 'ср. {speed} м/с',
    'combined.windMeanSpeedUnavailable': 'ср. — м/с',
    'combined.ready': 'оба поля',
    'combined.loading': 'загрузка',
    'combined.error': 'ошибка поля',
    'combined.independent': 'Поля независимы · не суммарный вектор',
    'combined.deltaUnknown': 'Δt —',
    'combined.deltaMinutes': 'Δt {minutes} мин',
    'combined.deltaHours': 'Δt {hours} ч',
    'combined.deltaHoursMinutes': 'Δt {hours} ч {minutes} мин',
    'weather.directionNote': 'Стрелки показывают, куда движется воздух. Точная локальная скорость ветра доступна по клику.',
    'weather.popupTitle': 'ВЕТЕР · ECMWF IFS',
    'weather.speed': 'СКОРОСТЬ',
    'weather.from': 'ОТКУДА (FROM)',
    'weather.to': 'КУДА (TO)',
    'weather.components': 'КОМПОНЕНТЫ',
    'weather.height': 'ВЫСОТА',
    'weather.modelTime': 'ВРЕМЯ МОДЕЛИ',
    'weather.forecastRun': 'FORECAST RUN',
    'weather.source': 'ИСТОЧНИК',
    ...
    'satellite.useAsSeed': 'Использовать как seed OpenDrift',
  ...
  en: {
    ...
    'ocean.source': 'SOURCE',
    'weather.layers': 'ATMOSPHERE',
    'air.cams': 'Air quality · CAMS',
    'air.pollutant': 'Pollutant',
    'air.ready': 'CAMS · field ready',
    'air.readyDetailed': 'CAMS · {pollutant} · {time} · model forecast',
    'air.loading': 'Loading CAMS…',
    'air.off': 'CAMS · layer off',
    'air.error': 'CAMS unavailable: {message}',
    'air.modelForecast': 'Model forecast · CAMS Ensemble',
    'air.minimum': 'MIN',
    'air.mean': 'MEAN',
    'air.maximum': 'MAX',
    'air.opacity': 'Field opacity',
    'air.opacityAria': 'CAMS air-quality field opacity',
    'air.clickHint': 'Click the field to inspect the local model concentration.',
    'air.popupTitle': 'AIR QUALITY · CAMS',
    'air.value': 'CONCENTRATION',
    'air.validTime': 'MODEL TIME',
    'air.forecastRun': 'FORECAST RUN',
    'air.model': 'MODEL',
    'air.modelDisclaimer': 'CAMS Ensemble model value. This is not a ground-station measurement.',
    'weather.wind10m': 'Wind · ECMWF IFS',
    'weather.windOff': 'ECMWF IFS · wind field',
    'weather.windLoading': 'Loading ECMWF IFS wind field…',
    'weather.windReady': 'ECMWF IFS · {time} · {count} vectors · run {run}',
    'weather.windError': 'Wind unavailable: {message}',
    'weather.arrowSize': 'Arrow size',
    'weather.arrowSizeAria': 'Wind arrow size',
    'weather.displayMode': 'Display',
    'weather.displayModeAria': 'Wind display mode',
    'weather.modeArrows': 'Arrows',
    'weather.modeParticles': 'Particles',
    'weather.modeBoth': 'Arrows + particles',
    'weather.particleCount': 'Particle count',
    'weather.particleCountAria': 'Wind particle count',
    'weather.particleSpeed': 'Animation speed',
    'weather.particleSpeedAria': 'Wind animation speed',
    'weather.particleTrail': 'Trail length',
    'weather.particleTrailAria': 'Wind particle trail length',
    'weather.particleSize': 'Particle size',
    'weather.particleSizeAria': 'Wind particle size',
    'combined.title': 'COMBINED MODE',
    'combined.currents': 'Currents',
    'combined.wind': 'Wind',
    'combined.windMeanSpeed': 'avg {speed} m/s',
    'combined.windMeanSpeedUnavailable': 'avg — m/s',
    'combined.ready': 'both fields',
    'combined.loading': 'loading',
    'combined.error': 'field error',
    'combined.independent': 'Independent fields · not a resultant vector',
    'combined.deltaUnknown': 'Δt —',
    'combined.deltaMinutes': 'Δt {minutes} min',
    'combined.deltaHours': 'Δt {hours} h',
    'combined.deltaHoursMinutes': 'Δt {hours} h {minutes} min',
    'weather.directionNote': 'Arrows show where the air moves TO. Exact local wind speed is available on click.',
    'weather.popupTitle': 'WIND · ECMWF IFS',
    'weather.speed': 'SPEED',
    'weather.from': 'FROM',
    'weather.to': 'TO',
    'weather.components': 'COMPONENTS',
    'weather.height': 'HEIGHT',
    'weather.modelTime': 'MODEL TIME',
    'weather.forecastRun': 'FORECAST RUN',
    ...
    'satellite.useAsSeed': 'Use as OpenDrift seed',
